...
class JiraUtilsTests(unittest.TestCase):
    def test_YARN_10496(self):
        ...
        set_diff = actual_jira_ids.difference(expected_jira_ids)
        self.assertTrue(len(set_diff) == 0, "Difference of expected jira ids / actual jira ids sets should be empty! Difference: " + str(set_diff))
